...
function setupPlaylists() {
    ...
    document.addEventListener('click', function (e) {
        if (e.target.classList.contains('edit-btn')) {
            return onEditPlaylistClicked(e.target, true)
        }
            ...
            if (playlist._id == plID) {
                ...
                if (playlist.tracks.length < 1) {
                    ...
                    doJSONRequest("GET", "/tracks", null, null, function (tracks) {
                        ...
                        dust.render("playlisttracks", { "tracks": tracksData }, function (err, out) {
...
//added dust file
function onEditPlaylistClicked(e, isplaylist) {

    console.log("ONEDITPLAYLISTCLICKED: ", e)
    console.log(isplaylist)

    if (isplaylist) {

        console.log("a playlist has been clicked!")
        ...
        console.log("a FLplaylist has been clicked!")
        onDeleteFollowedPlaylistClicked(playlistID)
...
function setupFollowedPlaylists() {
    ...
    document.addEventListener('click', function (e) {
        ...
        if (e.target.classList.contains('edit-btn2')){
            e.preventDefault();
            return onEditPlaylistClicked(e.target, false)
        }
    });
...
function renderFollowedPlaylist(pl) {
    ...
    doJSONRequest("GET", "/tracks", null, null, function (tracks) {
        ...
        dust.render("playlisttracks", data, function (err, out) {
...
function onDeleteFollowedPlaylistClicked(FLPLid) {
