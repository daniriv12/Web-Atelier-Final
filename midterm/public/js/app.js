...
function checkUser(){
    ...
    //get data from user form here
    var newUser = {

    };

    doJSONRequest("GET", '/users', {}, null, function (err, result) {
        ...
        for (var x = 0; x<allUsers.length ; x++){
            ...
            if (allUsers[x].userName == newUser.userName){
                if (allUsers[x].password == newUser.password){
                    return true;

                }
                //this means username is right but password is wrong, alert it
                return false;
            }
